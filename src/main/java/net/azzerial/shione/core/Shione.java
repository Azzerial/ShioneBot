...
import net.azzerial.shione.commands.AdminCommand;
import net.azzerial.shione.commands.EvalCommand;
import net.azzerial.shione.commands.GuildCommand;
import net.azzerial.shione.commands.HelpCommand;
import net.azzerial.shione.commands.OpCommand;
import net.azzerial.shione.commands.RegisterCommand;
import net.azzerial.shione.commands.ShutdownCommand;
import net.azzerial.shione.commands.TestCommand;
import net.azzerial.shione.commands.WhoisCommand;
